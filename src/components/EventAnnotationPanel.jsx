  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "10px", padding: "12px", borderRadius: "10px", border: "1px solid rgba(255,255,255,0.08)", background: "rgba(0,0,0,0.18)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
        ...
        <select disabled={disabled} value={mode} onChange={event => { setMode(event.target.value); setRangeStartMs(null); }} style={{ padding: "6px", borderRadius: "6px", background: "#111", color: "#fff", border: "1px solid #27272a" }}>
      ...
      {mode === "point" ? (
        <button disabled={disabled} onClick={submitPoint} style={{ padding: "7px", border: "none", borderRadius: "6px", fontWeight: 800, cursor: disabled ? "not-allowed" : "pointer" }}>
